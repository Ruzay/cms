...
if(isset($_POST['btn_sub'])){
	...
	mysqli_query($conn, "INSERT INTO sys_users (admin_id, username, position, password, church, church_name,name) VALUES ('$admin_id', '$user', '$role', '$pass', '$code', '$name','$fname')");
      ...
      <div class="row">
        <div class="col-md-3">
         ...
         <div class="box box-primary">
	        ...
	        <a href="edit_pass.php?id=<?php echo $id;?>" class="btn btn-primary btn-block margin-bottom" ><b>Check Password</b></a>
    ...
    <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#activity" data-toggle="tab">SET PASSWORD</a></li>
			</ul>
			...
			<div class="active tab-pane" id="activity">
              <form class="form-horizontal" method="post">
                 <div class="form-group">
					   ...
					   <input type="hidden" name="church_name" value="<?php echo $church_name ?>">
                       <input type="text" name="nametxt" class="form-control" value="<?php echo $name ?>" required>
				       </div>
                   </div>
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="usertxt" class="form-control"  placeholder="username" required>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="passtxt" class="form-control"  placeholder="password" required>
                    </div>
                  </div>
				   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                       <select name="roletxt" id="textbox"  style="width: 100%;" required>
