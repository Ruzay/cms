<section class="sidebar">
     ...
     <?php
      ...
      <ul class="sidebar-menu">
        <a href="../money.php"><li class="header">MAIN NAVIGATION</li></a>
        <li class="treeview">
          <a href="#">
        ...
        <li>
          <a href="#">
		   ...
		   <ul class="treeview-menu">
            ...
            <li><a href="money/view_exp.php"><i class="fa fa-circle-o"></i> View expenditure</a></li>
           </ul>
		</li>
		   <li>
          <a href="#">
		   ...
		   <ul class="treeview-menu">
            ...
            <li><a href="money/minutes.php"><i class="fa fa-circle-o"></i> Read</a></li>
           </ul>
		</li>
             <li>
          <a href="#">
